...
const PageNotFound = () => {
  return (
    <div className=" w-100 px-5 flex justify-center items-center min-h-screen bg-slate-500">
      <div>
        <img
          src={error404Img}
          alt="404ErrorImg"
        ...
        <div className=" text-center mt-4">
          <Link to={"/"}>
            <button className="flex group items-center gap-2 m-auto py-3 px-5 text-black font-semibold bg-slate-200 rounded-full hover:bg-slate-900 duration-300 hover:text-white max-sm:text-sm">
